...
class TermsAndConditionsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scrollView.viewTreeObserver.addOnScrollChangedListener {
            ...
            if (scrollView.scrollY >= maxScroll - 50) {
                ...
                if (!agreeButton.isEnabled) {
                    ...
                    Toast.makeText(this, "規約全文を確認しました。同意ボタンが有効になりました。", Toast.LENGTH_SHORT).show()
                }
            }
        }
        ...
        agreeButton.setOnClickListener {
            // TODO: 同意後の遷移先画面の作成後にロジックを修正
            Toast.makeText(this, "利用規約に同意しました", Toast.LENGTH_SHORT).show()
            finish()
        }
